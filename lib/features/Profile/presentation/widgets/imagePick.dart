...
class ImagePick extends StatefulWidget {
  ...
  const ImagePick({Key key, this.firstConexion}) : super(key: key);
  @override
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                     if (path.length > 0) dispatchGoToImageDisplayEvent(File(path),firstConexion);
                  },
                  child: Text(
...
//load the album list
  ...
  void dispatchGoToImageDisplayEvent(File image,bool firstConexion) {
    // Clearing the TextField to prepare it for the next inputted number
    BlocProvider.of<ProfileBloc>(context)
        .add(GoToImageDisplayEvent(image: image,firstConexion: firstConexion));
  }
}
