...
import 'package:oikosmobile/core/Utils/circleProgress.dart';
...
class AddPropertiesDisplay extends StatefulWidget {
  final User user;
  final String token;
  ...
  const AddPropertiesDisplay({Key key, this.user, this.token,this.propertiesModel,this.listTypesOfProperties,this.listProp}) : super(key: key);
  @override
  _AddPropertiesDisplayState createState() => _AddPropertiesDisplayState();
}

class _AddPropertiesDisplayState extends State<AddPropertiesDisplay> with TickerProviderStateMixin {
  int _groupValue = 1;
  int _groupValue7 =0 ;
  ...
  void initState() {
    ...
    if(propertiesModel != null){
      _groupValue = propertiesModel.owner?1:0;
       ...
       _groupValue1 = propertiesModel.hasPlannedWork?1:0;
       _groupValue2 = propertiesModel.hasDependancy?1:0;
  ...
  Widget build(BuildContext context) {
    ...
    List<PropertiesModel>listProp = widget.listProp;
     List<TypesOfProperties> listTypesOfProperties=widget.listTypesOfProperties;
    return Stack(
      children: [
        Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      CustomInputBien(
                        text: "Surface m2",
                        initialValue: (allArea == null)?null:allArea.toString(),
                        onChanged: (value){
...
/*                      Column(
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: Container(
                                  ...
                                  hint: Text("Année de construction",
                                      style: TextStyle(
                                        fontFamily: 'Multi',
                                    ...
                                    value: valueChoose,
                                    icon: Icon(Icons.keyboard_arrow_down,color: Color(0xFF959595),),
                                    iconSize: 36,
                                    isExpanded: true,
                                    style: TextStyle(
                                      fontFamily: 'Multi',
                      ...
                      CustomInputBien(
                        initialValue: (livingArea== null)?null:livingArea.toString(),
                      ...
                      CustomInputBien(
                        ...
                        initialValue: (homeArea== null)?null:homeArea.toString(),
                        onChanged: (value){
                            ...
                            animation = Tween<double>(begin: 0,end: 100).animate(progressController)..addListener((){
                              setState(() {
                                ...
                                if(animation.value == 100){
                                  ...
                                  dispatchAddPropertiesEvent(token,propertiesModel);
                                }
                              });
                            });
  ...
  void dispatchGoHomeDisplayEvent(User user,String token) {
    BlocProvider.of<PropertiesBloc>(context)
        .add(GoHomeDisplayEvent(user: user,token: token));
  }
  void dispatchAddPropertiesEvent(String token ,PropertiesModel propertiesModel) {
    print("from display token");
    print(token);
    BlocProvider.of<PropertiesBloc>(context)
        .add(CreatePropertiesEvent(token:token,propertiesModel: propertiesModel ));
  }
