...
class AddAnotherEvery18hDisponibilityDisplay extends StatefulWidget {
  final User user;
  final String token;
  ...
  const AddAnotherEvery18hDisponibilityDisplay({Key key, this.user, this.token, this.listProp, this.propertiesModel, this.calendarMonth, this.calendar}) : super(key: key);
  @override
  _AddAnotherEvery18hDisponibilityDisplayState createState() => _AddAnotherEvery18hDisponibilityDisplayState();
}

class _AddAnotherEvery18hDisponibilityDisplayState extends State<AddAnotherEvery18hDisponibilityDisplay> {
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: (){
                                ...
                                dispatchGoToEvery18hWeekendDayDisponibilityDisplayEvent(calendarMonth,calendar);
                              },
                              child: Material(
                                type: MaterialType.transparency,
                                child: Padding(
  ...
  String dayFormate(CalendarMonth month,int index){
    return textDisplay(month)+"\n / "+month.monthName+" "+month.year.toString()+" / "+month.listTimes[index].title;
  ...
  void selectType(CalendarMonth date,int index){
    ...
    switch(date.index){
      case 1: for(var day in date.days){
      ...
      break;
      case 4 : for(var day in date.days){
        if(day.thisMonth){
          day.listTimes[index].appointmentType = date.listTimes[index].appointmentType;
          day.selected = true;
          day.listTimes[index].selected = true;
      ...
      break;
      case 5 : for(var day in date.days){
        if(day.thisMonth&&!(day.date.weekday == DateTime.sunday)&&!(day.date.weekday == DateTime.saturday)){
          day.listTimes[index].appointmentType = date.listTimes[index].appointmentType;
          day.selected = true;
          day.listTimes[index].selected = true;
