...
class UpdateEvery18hweekendDisponibility extends StatefulWidget {
  final User user;
  final String token;
  ...
  const UpdateEvery18hweekendDisponibility({Key key, this.user, this.token, this.listProp, this.propertiesModel, this.calendarMonth, this.calendar}) : super(key: key);
  @override
  _UpdateEvery18hweekendDisponibilityState createState() => _UpdateEvery18hweekendDisponibilityState();
}

class _UpdateEvery18hweekendDisponibilityState extends State<UpdateEvery18hweekendDisponibility> {
