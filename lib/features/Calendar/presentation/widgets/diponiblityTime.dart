...
class DisponibltyTime extends StatefulWidget {
  final User user;
  final String token;
  ...
  const DisponibltyTime({Key key, this.user, this.token, this.listProp, this.propertiesModel, this.date, this.time,this.calendar}) : super(key: key);
  @override
  _DisponibltyTimeState createState() => _DisponibltyTimeState();
}

class _DisponibltyTimeState extends State<DisponibltyTime> {
