...
class EveryWeekend extends StatefulWidget {
  final User user;
  final String token;
  ...
  const EveryWeekend({Key key, this.user, this.token, this.listProp, this.propertiesModel, this.calendarMonth, this.calendar}) : super(key: key);
  @override
  _EveryWeekendState createState() => _EveryWeekendState();
}

class _EveryWeekendState extends State<EveryWeekend> {
